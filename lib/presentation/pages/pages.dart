export 'package:client/presentation/pages/auth/login.dart';
export 'package:client/presentation/pages/auth/register.dart';
export 'package:client/presentation/pages/main/main.dart';
